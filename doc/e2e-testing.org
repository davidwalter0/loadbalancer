...
The loadbalancer project includes a comprehensive end-to-end (E2E)
testing framework that verifies the functionality of the loadbalancer
in a real Kubernetes environment. This document describes how to use
and extend the E2E testing framework.
